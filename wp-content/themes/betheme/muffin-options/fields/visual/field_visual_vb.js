(function($) {
  ...
  var MfnFieldVisual = (function() {
    ...
    function bind(){
      $(document).on('mfn:vb:edit', function( $this, modal ){
        create();
      });

      $(document).on('mfn:vb:close', function( $this, modal ) {
        //destroy();
      });
    }
