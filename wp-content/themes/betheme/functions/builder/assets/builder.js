...
(function($) {
  ...
  var MfnBuilder = (function($) {
    ...
    var preview = {
      ...
      button: function(){
        setTimeout(function() {
  				$('#editor').find('.edit-post-header .edit-post-header__settings').prepend( '<button type="button" class="components-button is-tertiary mfn-preview">Muffin Preview</button>' );
  			}, 1000);
      },
      ...
      classicButton: function(){
  			$('#preview-action').append( '<a style="margin-right:5px" class="mfn-preview button" href="#">Muffin Preview</a>' );
      },
    ...
    var addHTMLbyJS = function(){
      ...
      $builder.closest('.postbox').find('.postbox-header .hndle').prepend('<a class="postbox-header-hint" target="_blank" href="https://support.muffingroup.com/faq/how-can-i-get-back-to-the-old-muffin-builder/">Prefer the old Muffin Builder look?</a>');
