...
class Mfn_Elementor_Widget_Article_Box extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Be • Article box', 'mfn-opts' );
	}
