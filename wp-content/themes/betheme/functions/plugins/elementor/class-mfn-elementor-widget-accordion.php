...
{
	class Mfn_WPML_Elementor_Widget_Accordion extends WPML_Elementor_Module_With_Items {
...
class Mfn_Elementor_Widget_Accordion extends \Elementor\Widget_Base {
	...
	public function wpml_widgets_to_translate_filter( $widgets ) {
	  ...
	  $widgets[ $this->get_name() ] = [
			...
			'integration-class' => 'Mfn_WPML_Elementor_Widget_Accordion',
	  ];
  ...
  public function get_script_depends() {
		if ( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			wp_register_script( 'mfn-accordion', get_theme_file_uri( '/functions/plugins/elementor/assets/widget-accordion-preview.js' ), [ 'elementor-frontend' ], MFN_THEME_VERSION, true );
			return [ 'mfn-accordion' ];
		}
	...
	public function get_title() {
		return __( 'Be • Accordion', 'mfn-opts' );
	}
    ...
    $repeater = new \Elementor\Repeater();
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Title', 'mfn-opts' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Accordion title', 'mfn-opts' ),
				'dynamic' => [
					'active' => true,
				],
				'label_block' => true,
        ...
        'description' => __('<b>JavaScript</b> content like Google Maps and some plugins shortcodes do <b>not work</b> in tabs', 'mfn-opts'),
				...
				'default' => __( 'Accordion content', 'mfn-opts' ),
				'show_label' => false,
			]
		);
